...
const Popover = React.forwardRef(({ bsPrefix, placement, className, style, children, body, popper: _, show: _1, ...props }, ref) => {
...
const Fade = React.forwardRef(({ className, children, transitionClasses = {}, ...props }, ref) => {
    ...
    return (React.createElement(TransitionWrapper, { ref: ref, addEndListener: transitionEndListener, ...props, onEnter: handleEnter, childRef: getChildRef(children) }, (status, innerProps) => React.cloneElement(children, {
        ...innerProps,
...
const Overlay = React.forwardRef(({ children: overlay, transition, popperConfig = {}, rootClose = false, ...outerProps }, outerRef) => {
    const popperRef = useRef({});
    const [ref, modifiers] = useOverlayOffset(outerProps.offset);
    const mergedRef = useMergedRefs(outerRef, ref);
    const actualTransition = transition === true ? Fade : transition || undefined;
    return (React.createElement(BaseOverlay, { ...outerProps, rootClose: rootClose, ref: mergedRef, popperConfig: {
            ...popperConfig,
