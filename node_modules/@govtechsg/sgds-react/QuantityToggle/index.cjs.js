...
const QuantityToggle = React__namespace.forwardRef(({ size, step = 1, disabled, variant, count, setCount, ...props }, ref) => {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        React__namespace.createElement(InputGroup$1, { size: size, variant: "quantity-toggle" },
            React__namespace.createElement(Button, { onClick: onMinus, ...buttonProps, "aria-label": `decrease by ${step}`, disabled: count < 1 },
                React__namespace.createElement("i", { className: "bi bi-dash" })),
            React__namespace.createElement(FormControl$1, { ...props, disabled: disabled, ref: ref, type: "number", className: "text-center", value: count.toString(), name: "quantity", onKeyDown: handleKeyDown, onChange: onChangeInput, min: 0 }),
